...
import time
def generate_sticky_notes(company_name, company_description,hot_topics,departments,more_info=""):
...
", ".join([ "Precious Metals Trading", "Investment Services", "Financial Analysis", "Risk Management", "Commodity Research", "Client Relations", "Market Operations" ])
  ...
  "stickyNotes": [
    ...
    "Action items for upcoming gold market presentations."
          ...
          {
              "role": "user",
              "content": get_sticky_note_prompt(company_name, company_description,hot_topics,departments,more_info)
          }
      ],
      temperature=0.5,
      max_tokens=1024,
